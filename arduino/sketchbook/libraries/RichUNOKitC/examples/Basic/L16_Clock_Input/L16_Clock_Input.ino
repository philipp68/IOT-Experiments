/************************************************* ************************************************** ******
* OPEN-SMART Rich UNO R3 Lesson 16: Clock input
...
************************************************** ************************************************** *****/
/**********************CHINESE*************************** ************************************************** ******
* OPEN-SMART Rich UNO R3 第16课: 触摸输入日期、时间
* 注意：在烧程序之前请确保CR1220电池已经安装正确了
* 学习使用触摸输入年，月，日，周，小时，分钟，初始化时钟模块数据，
*，您可以从Arduino IDE的串行监视器中看到您的设置是否正常。
*
* 以下函数是本节用到的：
